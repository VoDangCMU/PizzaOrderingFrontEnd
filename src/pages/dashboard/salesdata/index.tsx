...
import data from "@/pages/dashboard/salesdata/data"
                                                ...
                                                <CommandGroup>
                                                    {cities
                                                        ...
                                                        .map((c) => (
                                                            ...
                                                            >
                                                                <Check
                                                                    className={cn("mr-2 h-4 w-4", city === c.value ? "opacity-100" : "opacity-0")}/>
                                                                {c.label}
                                                            </CommandItem>
                                                        ))}
                                                </CommandGroup>
                                            ...
                                            <CommandList>
                                                ...
                                                <CommandGroup>
                                                    {availableShops.map((s) => (
                                                        ...
                                                        >
                                                            <Check
                                                                className={cn("mr-2 h-4 w-4", shop === s.value ? "opacity-100" : "opacity-0")}/>
                                                            {s.label}
                                                        </CommandItem>
                                                    ))}
                                                </CommandGroup>
                                            ...
                                            <CommandList>
                                                ...
                                                <CommandGroup>
                                                    {productCategories.map((c) => (
                                                        ...
                                                        >
                                                            <Check
                                                                className={cn("mr-2 h-4 w-4", category === c.value ? "opacity-100" : "opacity-0")}/>
                                                            {c.label}
                                                        </CommandItem>
                                                    ))}
                                                </CommandGroup>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                {filteredData.length > 0 && (
                                    <div className="flex space-x-4 text-sm text-pink-600">
                                        <div>
                                            Total
                                            Quantity: {filteredData.reduce((sum, item) => sum + item.TotalQuantity, 0).toLocaleString()}
                                        </div>
                                        <div>
                                            Total Revenue: $
                                            {filteredData
                                    ...
                                    <TableRow className="bg-pink-50">
                                        {dateType === "year" ? (
                                            <>
                                                ...
                                                <TableHead className="text-right text-pink-700 w-1/6">Revenue
                                                    (USD)</TableHead>
                                            </>
                                        ) : dateType === "month" ? (
                                            <>
                                                ...
                                                <TableHead className="text-right text-pink-700 w-1/7">Revenue
                                                    (USD)</TableHead>
                                            </>
                                        ) : (
                                            <>
                                                ...
                                                <TableHead className="text-right text-pink-700">Revenue
                                                    (USD)</TableHead>
                                            </>
                                        )}
                                    </TableRow>
                                ...
                                <TableBody>
                                    {dateType === "year" ? (
                                        ...
                                        filteredData.map((item, index) => (
                                            <TableRow key={index} className="hover:bg-pink-50">
                                                <TableCell
                                                    className="whitespace-nowrap">{formatDate(item.Day, item.Month, item.Year)}</TableCell>
